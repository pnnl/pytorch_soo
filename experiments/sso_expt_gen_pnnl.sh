#!/bin/bash
#SBATCH --job-name=sso_expt_gen_all
...
python3 sso_expts_pnnl.py --optimizer fr --force
python3 sso_expts_pnnl.py --optimizer bfgs --force
python3 sso_expts_pnnl.py --optimizer kn --force